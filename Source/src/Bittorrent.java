 ...
 * @author OPTIMUS
 */
public class Bittorrent extends javax.swing.JFrame {

    /**
     * Creates new form Bittorrent
     */
    public static PeerInfo peer;
    public static int portlisten = 1991;
    public static int portdow = 1001;
    public static ThreadListener nghe;
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        LogFile.WriteToFile(Bittorrent.logString);
   ...
   /*
    ...
    private void btnXemLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemLogActionPerformed
        // TODO add your handling code here:
        frmLog flog = new frmLog(Bittorrent.logString);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bittorrent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bittorrent().setVisible(true);
            }
        });
    }
