...
public class ThreadNoiFile extends Thread implements EventListener{
    ...
    public void NoiFile() {
        ...
        try {
            fInfo.kiemTraVaTaoThuMuc(ThongTinChunk.duongDanLuuFileGhep + tenfile + "/");
            fo = new FileOutputStream(ThongTinChunk.duongDanLuuFileGhep + tenfile + "/" + tenfile);
            buffer = new byte[(int) fInfo.getKichThuocChunk()];
            LogFile.Write("So chunk: " + fInfo.getSochunk());
            ...
            if (listeners != null && !listeners.isEmpty()) {
                ...
                LogFile.Write("Noi thanh cong " + ThongTinChunk.duongDanLuuFileGhep + tenfile + "/" + tenfile);
